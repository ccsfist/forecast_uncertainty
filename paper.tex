...
% take a look at Kevin's github for some references of how to code this

% discuss how uncertainty increases as frequency increases

\subsubsection{Ethiopia}

\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{2. figures/ethiopia.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{2. figures/madagascar.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{2. figures/guatemala-jja.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{2. figures/niger.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{2. figures/djibouti-ond.png}
\end{figure}
